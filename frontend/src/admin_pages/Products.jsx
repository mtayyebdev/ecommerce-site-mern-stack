      ...
      <div className="filters">
        <div className="box max-w-md mb-4 mt-4">
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search" class="block outline-none w-full py-3 px-1 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search Products name..." required />
        ...
        <div className="selecters max-w-4xl flex-wrap flex items-center justify-between gap-3">
          <div class="min-w-[200px]">
            ...
            <select id="countries" class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
          ...
          <div class="min-w-[200px]">
            <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Select Color</label>
            <select id="countries" class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
          ...
          <div class="min-w-[200px]">
            <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Select Ratings</label>
            <select id="countries" class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
