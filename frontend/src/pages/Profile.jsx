      ...
      <div className="w-full py-4">
        <div className="flex flex-row gap-3">
          <div className="asid relative">
            ...
            <aside className={`w-64 lg:w-[200px] p-3 absolute lg:static bg-white top-0 h-full lg:h-auto lg:bg-transparent shadow-md lg:shadow-none rounded-lg lg:rounded-none ${menu?"translate-x-0":"-translate-x-[200%]"} transition-all lg:block lg:translate-x-0`}>
              ...
              <nav>
                ...
                <ul className="space-y-2 ms-4 text-sm">
                  ...
                  <NavLink to={"/user/payment"}><li className=" hover:text-blue-600">My Payment Options</li></NavLink>
                </ul>
                ...
                <ul className="space-y-2 ms-4 text-sm">
                  ...
                  <NavLink to={"/user/cancellations"}><li className=" hover:text-blue-600">My Cancellations</li></NavLink>
                </ul>
